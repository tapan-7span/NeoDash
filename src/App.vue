<template>
  <div class="dark:bg-gray-800 dark:text-white">
    ...
    <button
      @click="changeTheme()"
      class="fixed bottom-4 right-4 px-4 py-2 rounded-lg shadow text-white font-semibold text-sm transition-colors duration-300"
      :class="[
        darkTheme
          ? 'bg-gradient-to-tr from-black to-white'
